...
def get_closest_current(glider_long, glider_lat):
    ...
    ubarEast = np.load(r"C:\Users\arian\Desktop\Autonomous Systems 2024\ubarEast.npy")

    vbarNorth = np.load(r"C:\Users\arian\Desktop\Autonomous Systems 2024\vbarNorth.npy")

    lats = np.load(r"C:\Users\arian\Desktop\Autonomous Systems 2024\lats.npy")

    longs = np.load(r"C:\Users\arian\Desktop\Autonomous Systems 2024\longs.npy")
